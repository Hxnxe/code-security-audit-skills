...
## Source Droid
- Prompt source: code-security-audit-skills/droids/droids/infra-scanner.md
...
## Output
- Primary target: audit/scanner-alerts/infra-scanner.md (ALERT/STATS only; master later merges into audit/risk-map.md)
