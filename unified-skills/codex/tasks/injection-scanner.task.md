# Task: injection-scanner

## Runtime
codex

## Source Droid
- Prompt source: code-security-audit-skills/droids/droids/injection-scanner.md
...
## Output
- Primary target: audit/scanner-alerts/injection-scanner.md (ALERT/STATS only; master later merges into audit/risk-map.md)
